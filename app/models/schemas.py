...
class LeadExtraction(BaseModel):
    ...
    whatsapp_number: Optional[str] = Field(None, description="A DIFFERENT phone number the PROSPECT gave for WhatsApp, digits only, no spaces or +. Null when they agreed to 'this number', gave none, or only the Agent mentioned a number.")
